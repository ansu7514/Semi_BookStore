...
<div class="form-inline" style="margin-left: 10px;">
		...
		&nbsp;&nbsp;
		<button type="submit" class="btn btn-delfault" style="width: 100px;">수정하기</button>
</div>
</form>
</div>
...
<%}else //action처리
{
	...
	if(b)
	{
		//response.sendRedirect("../index.jsp?main=login/member_updateform.jsp?user_id="+user_id);
	}else
	{%>
